...
const HerbalistProfile = () => {

  const { dToken, profileData, setProfileData, getProfileData, backendUrl } = useContext(HerbalistContext)
  ...
  const updateProfile = async () => {
    try {
      ...
      const { data } = await axios.post(backendUrl + '/api/herbalist/update-profile',updateData,{headers:{dToken}})
      if (data.success) {
